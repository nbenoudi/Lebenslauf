...
function Contact({Headerkey}) {
    ...
    useEffect( () => { 
        ...
        if (error) {
        return(<div className=" bg-red-100 px-20 right-1/2 rounded-xl text-2xl w-full" > <Error error={error}>{console.log(error)}</Error> </div>);
        }

          return( <div  className=" bg-slate-100 px-20 right-1/2 rounded-xl  w-full">
